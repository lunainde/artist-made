class ApplicationController < ActionController::Base
 ...
 after_action :verify_authorized, except: [:index, :paid_shopping_carts], unless: :skip_pundit?
 after_action :verify_policy_scoped, only: [:index, :paid_shopping_carts], unless: :skip_pundit?
